...
func (w *Wiki) initTagsService() error {
	...
	w.tagsEffect = pagesave.NewTagsSideEffect(w.tags, w.tree, w.log)
	return nil
}
...
func (w *Wiki) initPropertiesService() error {
	...
	w.propertiesEffect = pagesave.NewPropertiesSideEffect(w.props, w.tree, w.log)
	return nil
}
...
func (w *Wiki) initSearch() error {
	...
	w.searchEffect = pagesave.NewSearchIndexSideEffect(w.searchIndex, w.tree, w.log)
...
func (w *Wiki) buildPagesRoutes() *wikipages.Routes {
	...
	return wikipages.NewRoutes(wikipages.RoutesConfig{
		...
		ApplyRefactor:    wikipages.NewApplyPageRefactorUseCase(w.tree, w.slug, w.links, o, w.log),
